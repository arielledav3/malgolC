...
public class Parser
{
    ...
    private void reduce_0(int reduction) throws IOException, LexerException, ParserException
    {
        switch(reduction)
        {
            ...
            break;
            case 16: /* reduce ASomeDeclList */
            {
                ArrayList<Object> list = new16();
                push(goTo(7), list, false);
            }
            break;
            case 17: /* reduce ANoneDeclList */
            {
    ...
    ArrayList<Object> new8() /* reduce ABlockBlock */
    {
        ...
        pblockNode1 = new ABlockBlock(tlbraceNode2, pdecllistNode3, tseparatorNode4, pstmtlistNode5, trbraceNode6);
        }
    ...
    ArrayList<Object> new11() /* reduce ABlockStmt */
    {
        ...
        pstmtNode1 = new ABlockStmt(tlbraceNode2, pdecllistNode3, tseparatorNode4, pstmtlistNode5, trbraceNode6);
        }
	nodeList.add(pstmtNode1);
        return nodeList;
    }
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    ArrayList<Object> new16() /* reduce ASomeDeclList */
    {
        @SuppressWarnings("hiding") ArrayList<Object> nodeList = new ArrayList<Object>();
        ...
        pdecllistNode1 = new ASomeDeclList(pdeclNode2, pdecllistNode3);
        }
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    ArrayList<Object> new17() /* reduce ANoneDeclList */
    {
        @SuppressWarnings("hiding") ArrayList<Object> nodeList = new ArrayList<Object>();
        ...
        pdecllistNode1 = new ANoneDeclList();
        }
	nodeList.add(pdecllistNode1);
        return nodeList;
    }
...
/*      {
			...
			{{-1, REDUCE, 2}, {37, SHIFT, 1}, },
			{{-1, REDUCE, 5}, {37, SHIFT, 7}, },
			{{-1, REDUCE, 0}, },
			{{-1, REDUCE, 2}, {37, SHIFT, 1}, },
			{{-1, ERROR, 7}, {26, SHIFT, 11}, },
			{{-1, ERROR, 8}, {1, SHIFT, 12}, },
			{{-1, REDUCE, 7}, {12, SHIFT, 13}, },
			{{-1, REDUCE, 1}, },
			{{-1, ERROR, 11}, {23, SHIFT, 15}, {24, SHIFT, 16}, {25, SHIFT, 17}, },
			{{-1, ERROR, 12}, {26, SHIFT, 19}, },
			{{-1, ERROR, 13}, {37, SHIFT, 7}, },
			{{-1, REDUCE, 4}, },
			{{-1, REDUCE, 21}, },
			{{-1, REDUCE, 22}, },
			{{-1, ERROR, 17}, {36, SHIFT, 21}, },
			{{-1, REDUCE, 18}, },
			{{-1, ERROR, 19}, {23, SHIFT, 15}, {24, SHIFT, 16}, {25, SHIFT, 17}, },
			{{-1, REDUCE, 7}, {12, SHIFT, 13}, },
			{{-1, ERROR, 21}, {23, SHIFT, 15}, {24, SHIFT, 16}, {25, SHIFT, 17}, },
			{{-1, ERROR, 22}, {2, SHIFT, 25}, },
			{{-1, REDUCE, 6}, },
			{{-1, REDUCE, 23}, },
			{{-1, REDUCE, 17}, {37, SHIFT, 7}, },
			{{-1, REDUCE, 3}, },
			{{-1, ERROR, 27}, {4, SHIFT, 29}, },
			{{-1, REDUCE, 17}, {37, SHIFT, 7}, },
			{{-1, REDUCE, 20}, {2, SHIFT, 31}, {27, SHIFT, 32}, {28, SHIFT, 33}, {31, SHIFT, 34}, {33, SHIFT, 35}, {34, SHIFT, 36}, {37, SHIFT, 37}, },
			{{-1, REDUCE, 16}, },
			{{-1, REDUCE, 17}, {37, SHIFT, 7}, },
			{{-1, ERROR, 32}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 33}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 34}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, REDUCE, 14}, },
			{{-1, ERROR, 36}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, REDUCE, 51}, },
			{{-1, REDUCE, 20}, {2, SHIFT, 31}, {27, SHIFT, 32}, {28, SHIFT, 33}, {31, SHIFT, 34}, {33, SHIFT, 35}, {34, SHIFT, 36}, {37, SHIFT, 37}, },
			{{-1, ERROR, 39}, {3, SHIFT, 61}, },
			{{-1, ERROR, 40}, {5, SHIFT, 62}, {22, SHIFT, 63}, },
			{{-1, ERROR, 41}, {4, SHIFT, 64}, },
			{{-1, ERROR, 42}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 43}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 44}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, REDUCE, 47}, },
			{{-1, REDUCE, 46}, },
			{{-1, REDUCE, 51}, {0, SHIFT, 68}, },
			{{-1, REDUCE, 9}, {20, SHIFT, 69}, },
			{{-1, REDUCE, 25}, {19, SHIFT, 70}, },
			{{-1, REDUCE, 27}, },
			{{-1, REDUCE, 29}, },
			{{-1, REDUCE, 36}, {7, SHIFT, 71}, {8, SHIFT, 72}, {13, SHIFT, 73}, {14, SHIFT, 74}, {15, SHIFT, 75}, {16, SHIFT, 76}, {17, SHIFT, 77}, {18, SHIFT, 78}, },
			{{-1, REDUCE, 39}, {9, SHIFT, 79}, {10, SHIFT, 80}, {11, SHIFT, 81}, },
			{{-1, REDUCE, 43}, },
			{{-1, REDUCE, 45}, },
			{{-1, REDUCE, 48}, {5, SHIFT, 62}, },
			{{-1, ERROR, 57}, {20, SHIFT, 69}, {29, SHIFT, 82}, },
			{{-1, ERROR, 58}, {20, SHIFT, 69}, {32, SHIFT, 83}, },
			{{-1, REDUCE, 15}, {20, SHIFT, 69}, },
			{{-1, REDUCE, 19}, },
			{{-1, REDUCE, 8}, },
			{{-1, ERROR, 62}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 63}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, REDUCE, 20}, {2, SHIFT, 31}, {27, SHIFT, 32}, {28, SHIFT, 33}, {31, SHIFT, 34}, {33, SHIFT, 35}, {34, SHIFT, 36}, {37, SHIFT, 37}, },
			{{-1, ERROR, 65}, {1, SHIFT, 87}, {20, SHIFT, 69}, },
			{{-1, REDUCE, 44}, },
			{{-1, REDUCE, 28}, },
			{{-1, REDUCE, 54}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 69}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 70}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 71}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 72}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 73}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 74}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 75}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 76}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 77}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 78}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 79}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 80}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 81}, {0, SHIFT, 42}, {8, SHIFT, 43}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, ERROR, 82}, {2, SHIFT, 31}, {27, SHIFT, 32}, {28, SHIFT, 33}, {31, SHIFT, 34}, {33, SHIFT, 35}, {34, SHIFT, 36}, {37, SHIFT, 37}, },
			{{-1, ERROR, 83}, {2, SHIFT, 31}, {27, SHIFT, 32}, {28, SHIFT, 33}, {31, SHIFT, 34}, {33, SHIFT, 35}, {34, SHIFT, 36}, {37, SHIFT, 37}, },
			{{-1, ERROR, 84}, {6, SHIFT, 105}, {20, SHIFT, 69}, },
			{{-1, REDUCE, 10}, {20, SHIFT, 69}, },
			{{-1, ERROR, 86}, {3, SHIFT, 106}, },
			{{-1, REDUCE, 50}, },
			{{-1, REDUCE, 56}, {12, SHIFT, 107}, {20, SHIFT, 69}, },
			{{-1, ERROR, 89}, {1, SHIFT, 109}, },
			{{-1, REDUCE, 24}, {19, SHIFT, 70}, },
			{{-1, REDUCE, 26}, },
			{{-1, REDUCE, 37}, {9, SHIFT, 79}, {10, SHIFT, 80}, {11, SHIFT, 81}, },
			{{-1, REDUCE, 38}, {9, SHIFT, 79}, {10, SHIFT, 80}, {11, SHIFT, 81}, },
			{{-1, REDUCE, 30}, {7, SHIFT, 71}, {8, SHIFT, 72}, },
			{{-1, REDUCE, 31}, {7, SHIFT, 71}, {8, SHIFT, 72}, },
			{{-1, REDUCE, 34}, {7, SHIFT, 71}, {8, SHIFT, 72}, },
			{{-1, REDUCE, 35}, {7, SHIFT, 71}, {8, SHIFT, 72}, },
			{{-1, REDUCE, 32}, {7, SHIFT, 71}, {8, SHIFT, 72}, },
			{{-1, REDUCE, 33}, {7, SHIFT, 71}, {8, SHIFT, 72}, },
			{{-1, REDUCE, 40}, },
			{{-1, REDUCE, 41}, },
			{{-1, REDUCE, 42}, },
			{{-1, ERROR, 103}, {30, SHIFT, 110}, },
			{{-1, REDUCE, 13}, },
			{{-1, REDUCE, 52}, },
			{{-1, REDUCE, 11}, },
			{{-1, ERROR, 107}, {0, SHIFT, 42}, {8, SHIFT, 43}, {21, SHIFT, 44}, {35, SHIFT, 45}, {36, SHIFT, 46}, {37, SHIFT, 47}, },
			{{-1, REDUCE, 53}, },
			{{-1, REDUCE, 49}, },
			{{-1, ERROR, 110}, {2, SHIFT, 31}, {27, SHIFT, 32}, {28, SHIFT, 33}, {31, SHIFT, 34}, {33, SHIFT, 35}, {34, SHIFT, 36}, {37, SHIFT, 37}, },
			{{-1, REDUCE, 56}, {12, SHIFT, 107}, {20, SHIFT, 69}, },
			{{-1, REDUCE, 12}, },
			{{-1, REDUCE, 55}, },
        };*/
...
/*      {
			...
			{{-1, 14}, {20, 23}, },
			{{-1, 26}, },
			{{-1, 38}, {82, 103}, {83, 104}, {110, 112}, },
			{{-1, 27}, {28, 30}, {31, 41}, },
			{{-1, 28}, {4, 9}, {13, 20}, },
			{{-1, 39}, {38, 60}, {64, 86}, },
			{{-1, 18}, {19, 22}, {21, 24}, },
			{{-1, 48}, {33, 57}, {34, 58}, {36, 59}, {42, 65}, {62, 84}, {63, 85}, {68, 88}, {107, 111}, },
			{{-1, 49}, {69, 90}, },
			{{-1, 50}, {44, 67}, {70, 91}, },
			{{-1, 51}, },
			{{-1, 52}, {73, 94}, {74, 95}, {75, 96}, {76, 97}, {77, 98}, {78, 99}, },
			{{-1, 53}, {71, 92}, {72, 93}, },
			{{-1, 54}, {43, 66}, {79, 100}, {80, 101}, {81, 102}, },
			{{-1, 55}, },
			{{-1, 56}, {29, 40}, {38, 40}, {64, 40}, {82, 40}, {83, 40}, {110, 40}, },
			{{-1, 89}, },
			{{-1, 108}, {111, 113}, },
        };*/
...
/*      {
			0, 1, 2, 3, 4, 2, 3, 5, 6, 7, 2, 8, 5, 0, 6, 9, 9, 10, 11, 8, 7, 8, 12, 6, 9, 13, 3, 14, 13, 15, 14, 13, 16, 16, 16, 17, 16, 18, 15, 19, 18, 14, 16, 20, 16, 21, 21, 22, 23, 24, 24, 24, 25, 21, 21, 21, 26, 27, 28, 23, 19, 3, 16, 16, 15, 29, 21, 24, 30, 16, 16, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 31, 31, 32, 23, 19, 21, 33, 6, 24, 24, 21, 21, 34, 34, 34, 34, 34, 34, 21, 21, 21, 35, 17, 36, 17, 16, 6, 21, 31, 33, 17, 6, 
        };*/
