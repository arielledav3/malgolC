...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inASomeDeclList(ASomeDeclList node)
    {
        defaultIn(node);
    }

    public void outASomeDeclList(ASomeDeclList node)
    {
        defaultOut(node);
    }
    ...
    public void caseASomeDeclList(ASomeDeclList node)
    {
        ...
        outASomeDeclList(node);
    }

    public void inANoneDeclList(ANoneDeclList node)
    {
        defaultIn(node);
    }

    public void outANoneDeclList(ANoneDeclList node)
    {
        defaultOut(node);
    }
    ...
    {
        inANoneDeclList(node);
        outANoneDeclList(node);
    }
